...
export const setupBotCommands = (bot: Bot<BotCtx>) => {
  bot.api.setMyCommands([
    { command: 'start', description: 'Команда для запуска бота' },
    {
      command: 'weekly_news',
      description: 'Отображение списка всех новостей, которые должны выйти на этой неделе.',
    },
    {
      command: 'daily_news',
      description:
    ...
    {
      command: 'set_news_type',
      description: 'Команда для выбора типа новостей, который вы хотите получать.',
    },
    {
      command: 'help',
      description: 'Список всех команд, которые доступны в боте с примерами использования.',
    },
  ]);
};
