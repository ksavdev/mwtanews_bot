...
export const tzRegionMenu = new Menu<OuterCtx>("tz-menu")
...
/* ─── submenu: Азия ─── */
const asiaMenu = new Menu<OuterCtx>("tz-asia")
...
/* ─── submenu: Европа ─── */
const europeMenu = new Menu<OuterCtx>("tz-europe")
...
/* ─── submenu: Америка ─── */
const americaMenu = new Menu<OuterCtx>("tz-america")
  .text("UTC-11", async (ctx) => saveTz(ctx, "UTC-11"))
...
async function saveTz(ctx: OuterCtx, label: string) {
